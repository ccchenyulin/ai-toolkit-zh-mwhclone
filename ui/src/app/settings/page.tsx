    ...
    <>
      ...
      <MainContent>
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label htmlFor="TRAINING_FOLDER" className="block text-sm font-medium mb-2">
                    训练文件夹路径
                    <div className="text-gray-500 text-sm ml-1">
                      我们将在此存储训练信息。必须是绝对路径。如果留空，将默认使用项目根目录下的 output 文件夹。
                    </div>
                  </label>
                  <input
                    type="text"
                  ...
                  <label htmlFor="DATASETS_FOLDER" className="block text-sm font-medium mb-2">
                    ...
                    <div className="text-gray-500 text-sm ml-1">
                      ...
                      <span className="text-orange-800">
                        警告：本软件可能会修改数据集，因此建议您在其它位置保留备份，或为此软件指定一个专用文件夹。
                      </span>
                    </div>
                  </label>
                  <input
          ...
          {status === 'error' && <p className="text-red-500 text-center">保存设置失败，请重试。</p>}
        </form>
      </MainContent>
    </>
  );
